...
public class OutgoingWireTransfer {
  ...
  public OutgoingWireTransfer profileId(String profileId) {
   ...
   /**
   * The Id of the Outgoing Wire Transfer Profile that this transaction was created with.
   * @return profileId
  **/
  ...
  public OutgoingWireTransfer transferAmount(Object transferAmount) {
  ...
  **/
  ...
  public OutgoingWireTransfer sourceInstrument(OutgoingWireTransfersSourceInstrument sourceInstrument) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(profileId, transferAmount, destination, creationTimestamp, description, id, tag, state, type, sourceInstrument);
  }
