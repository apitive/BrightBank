...
public class CorporatesBody {
  ...
  **/
  ...
  public CorporatesBody profileId(String profileId) {
   ...
   /**
   * The Corporate Profile Id to be used to create the Corporate.  Profiles contain configuration and determine behavioral aspects of the newly created Corporate, for example, fees that may apply.  You can have one or more profiles linked to your application, and these can be used to drive different behaviors according to your product&#x27;s needs.  Profile Ids can be found in the Multi Portal, in the API Credentials page. 
   * @return profileId
  **/
  ...
  **/
  ...
  public CorporatesBody industry(Object industry) {
  ...
  **/
  ...
  public CorporatesBody sourceOfFunds(Object sourceOfFunds) {
