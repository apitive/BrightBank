...
Prefab.CardsTypeDataList1Mouseenter = function($event, widget) {
    ...
    if (widget.item.name == 'Physical Card') {
        source[0].picturesource = "resources/images/imagelists/img-physical-card-active.png";
    } else {
        source[1].picturesource = "resources/images/imagelists/img-virtual-card-active.png";
    }
...
Prefab.CardsTypeDataList1Mouseleave = function($event, widget) {
    ...
    // 
    if (widget.item.name == 'Physical Card') {
        source[0].picturesource = "resources/images/imagelists/img-physical-card-normal.png";
    } else {
        source[1].picturesource = "resources/images/imagelists/img-virtual-card-normal.png";
    }
