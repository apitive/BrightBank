...
Prefab.refreshTransactions = function() {
    ...
    if (Prefab.transactionlisttype == "Managed Account") {
        Prefab.Widgets.containerTransactions.Variables.JS_getAccountTransactions.invoke({
            inputFields: {
        ...
        Prefab.Widgets.containerTransactions.Variables.getAllTransactionsOfManagedCardById.invoke();
    }
};
...
Prefab.setFilter = function(dateinput) {
    Prefab.Widgets.containerTransactions.Variables.JS_getAccountTransactions.setInput("fromDate", dateinput);
    Prefab.Widgets.containerTransactions.Variables.JS_getAccountTransactions.invoke();
};
